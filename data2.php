...
//display the average rain status on the textarea
	...
	<div style="margin-left: 160px;">
	    <button type="submit" name="temperature" value="submit"  style="position: relative;color: #000;text-transform: uppercase;letter-spacing: 2px;font-size: 15px;">የሙቀት መጠን </button>
	    <button type="submit" name="humidity" value="submit" style="position: relative;color: #000;text-transform: uppercase;letter-spacing: 2px;font-size: 15px;">የአየር እርጥበት </button> 
	   	<button type="submit" name="rain" value="submit" style="position: relative;color: #000;text-transform: uppercase;letter-spacing: 2px;font-size: 15px;">የዝናብ መጠን </button>
	    </div><br><br>
</form>
<!--   list of 7 days information      -->
	<form method="post" style="margin-left: 150px;">
	<button type="submit" name="monday">
		<img src="/dtu/image/d11.jpg" width="80" height="70" border="0" />
	</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<button type="submit" name="tuesday">
		<img src="/dtu/image/d22.jpg" width="80" height="70" border="0" />
	</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<button type="submit" name="wednesday">
		<img src="/dtu/image/d33.jpg" width="80" height="70" border="0" />
	</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<form method="post">
	<button type="submit" name="thursday">
		<img src="/dtu/image/d44.jpg" width="80" height="70" border="0" />
	</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<button type="submit" name="friday">
		<img src="/dtu/image/d55.jpg" width="80" height="70" border="0" />
	</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<button type="submit" name="saturday">
		<img src="/dtu/image/d66.jpg" width="80" height="70" border="0" />
	</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<button type="submit" name="sunday">
		<img src="/dtu/image/d77.jpg" width="80" height="70" border="0" />
	</button>
</form>
<div style="margin-left: 150px;">
	...
	<div class="con">
		<div class="btn">
			<a href="/dtu/comment2.php">አስተያየት መስጫ</a>
		</div>
		</div>
</div>
</body>
